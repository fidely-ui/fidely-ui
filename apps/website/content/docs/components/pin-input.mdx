...
links:
  source: pin-input
  recipe: slot-recipe/pin-input.recipe
  ark: components/pin-input
---
...
### With Group and Separator

<Callout>
  **Important Note:** As of `v2.3.0`, you can now use `PinInput.Group` and
  `PinInput.Separator`.
</Callout>

<ExampleTabs name="pin-input-group" scope="pin-input" />
...
<ExampleTabs name="pin-input-example" scope="pin-input" />
...
| `colorPalette`    | `all available colors`                                                                                           | -           | The color palette of the component.                                                       |
