---
title: Dark Mode
description: Learn how to enable and manage dark mode in your Fidely UI project using next-themes.
---
...
Works perfectly with Fidely UI components — all dark mode tokens update instantly.
