---
title: Customization
description: Learn how to customize Fidely UI preset and Panda CSS for your design system.
---

# Fidely UI preset

Fidely UI is built on top of **Panda CSS**, so you can customize it at the token, theme, and component levels and
You can choose one **neutral(gray color)** and **accent color** for your brand
...
Some Fidely UI components, like **Accordion**, use slot recipes internally.
