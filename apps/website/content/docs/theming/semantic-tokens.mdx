...
description: Standardized design tokens for foreground, background, border, radii, shadows, and color palettes in Snaps UI.
---

Semantic tokens provide a consistent, theme-aware way to style components across Snaps UI.
